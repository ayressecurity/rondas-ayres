...
super_admin: lee el qr_token de un punto_control con la cámara y registra el
escaneo en libro_novedades. No tiene modelos propios (solo escribe en novedades).
