...
TIPOS_BASE = [
    ...
    {"codigo": "arribo_sin_conexion", "nombre": "Arribo sin conexión", "categoria": CategoriaEvento.RONDA},
    {"codigo": "ronda_cancelada", "nombre": "Ronda cancelada", "categoria": CategoriaEvento.RONDA},
